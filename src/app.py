...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim laps, improve technique, and compete in school meets",
    ...
    "Drama Club": {
        "description": "Acting workshops, scene study, and school theater productions",
    ...
    "Debate Team": {
        "description": "Develop public speaking and argument skills for debate tournaments",
